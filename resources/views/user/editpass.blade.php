                ...
                <div class="card-body">
                    <form id="editpass-form" method="post" action="{{route('user.updatepass')}}">
                        ...
                        <div class="form-control mb-4">
                            ...
                            <span id="toggle-old-password" toggle="#password-field" class="fa fa-fw fa-eye field_icon"
                        ...
                        <div class="form-control mb-4">
                            ...
                            <span id="toggle-new-password" toggle="#password-field" class="fa fa-fw fa-eye field_icon"
                                  style="position: relative;float: right"></span>
                        </div>
                        ...
                        <div class="form-control mb-4">
                            ...
                            <span id="toggle-password-confirm" toggle="#password-field"
                                  class="fa fa-fw fa-eye field_icon" style="position: relative;float: right"></span>
                        </div>
