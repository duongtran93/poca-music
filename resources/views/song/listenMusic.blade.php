    ...
    <div class="poca-music-area mt-100 d-flex align-items-center flex-wrap ml-2 mr-2" data-animation="fadeInUp"
        ...
        <div class="poca-music-content">
            ...
            <div class="music-meta-data">
                <p>By <a href="#" class="music-author">Admin</a> | <a href="#" class="music-catagory">Tutorials</a> | <a
                        href="#" class="music-duration">00:04:06</a></p>
            </div>
            ...
            <div class="likes-share-download d-flex align-items-center justify-content-between">
                ...
                <div>
                    ...
                    <div class="container">
                        @include('menu')
                        <div class="poca-music-area mt-100 d-flex align-items-center flex-wrap ml-2 mr-2"
                                ...
                                <div class="playlist-form">
                                    <form action="{{route('playlist.store')}}" method="post">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Nhập tên playlist"
                                                   autofocus name="name">
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-success btn-block playlist-btn mt-2">
                                                Lưu
                                            </button>
                                        </div>
                                    </form>
